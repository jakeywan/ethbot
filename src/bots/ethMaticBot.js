...
export const ethMaticBot = async () => {

  console.log('Listening to MATIC-ETH pools...')
  ...
  const loadPairs = async () => {
    sushiEthUSDC = await loadPair(maticAddress, wethAddress, 'SUSHI')
    quickSwapEthUSDC = await loadPair(maticAddress, wethAddress, 'QUICKSWAP')
    polyzapEthUSDC = await loadPair(maticAddress, wethAddress, 'POLYZAP')
    dfynEthUSDC = await loadPair(maticAddress, wethAddress, 'DFYN')
  }
